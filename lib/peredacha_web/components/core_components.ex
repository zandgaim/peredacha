defmodule PeredachaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PeredachaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PeredachaWeb.Gettext, "errors", msg, opts)
    end
  end
