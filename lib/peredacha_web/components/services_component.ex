defmodule PeredachaWeb.Components.ServicesComponent do
  ...
  defp service_card(assigns) do
    ...
    ~H"""
    <div class={[
      "flex h-full flex-col overflow-hidden rounded-2xl border border-base-content/10 bg-base-100 shadow-lg transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/20",
      @class
    ]}>
